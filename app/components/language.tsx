...
export default function Language() {
  return (
    <div className="flex flex-col w-full py-4">
        ...
        <div className="relative left-1/2 -translate-x-1/2 uppercase font-open text-[12px] text-[#cfcfcf] bg-white dark:bg-neutral-900 w-[calc(100%+2rem)] h-[30px] max-w-[450px] border-b border-l border-neutral-200 dark:border-neutral-800 justify-start px-3 flex items-center">
          languages
        </div>
        ...
        <div className="relative left-1/2 -translate-x-1/2 uppercase font-open text-[12px] text-[#cfcfcf] bg-white dark:bg-neutral-900 w-[calc(100%+2rem)] h-[30px] max-w-[450px] border-b border-l border-neutral-200 dark:border-neutral-800 flex flex-row items-center justify-start px-3 leading-none">
          frontend
        </div>
        ...
        {/* state and data */}
        <div className="relative left-1/2 -translate-x-1/2 h-[20px] w-[calc(100%+2rem)] max-w-[450px] pattern-hatch border-t border-b border-neutral-200 dark:border-neutral-800" />
        <div className="relative left-1/2 -translate-x-1/2 uppercase font-open text-[12px] text-[#cfcfcf] bg-white dark:bg-neutral-900 w-[calc(100%+2rem)] h-[30px] max-w-[450px] border-b border-l border-neutral-200 dark:border-neutral-800 flex items-center justify-start px-3 leading-none">
          state and data
        </div>
        <div className="flex flex-wrap gap-2 py-4">
          <ZustandPill />
